...
- {id: CLKO1_CLK.outFreq, value: 24 MHz}
...
- {id: FLEXSPI2_CLK_ROOT.outFreq, value: 144 MHz}
...
- {id: LPSPI_CLK_ROOT.outFreq, value: 36 MHz}
...
- {id: CCM.CLKO1_SEL.sel, value: CCM_ANALOG.PLL4_MAIN_CLK}
...
- {id: CCM_ANALOG.PLL3_PFD0_DIV.scale, value: '30', locked: true}
...
- {id: CCOSR_CLKO1_EN_CFG, value: 'Yes'}
sources:
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Init Usb1 pfd0. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd0, 30);
    /* Init Usb1 pfd1. */
    ...
    CCM->CCOSR = (CCM->CCOSR & (~CCM_CCOSR_CLKO1_SEL_MASK)) | CCM_CCOSR_CLKO1_SEL(15);
