...
C_SRCS += \
../user/tasks/camera_task.c \
../user/tasks/display_task.c \
../user/tasks/param.c 

OBJS += \
./user/tasks/camera_task.o \
./user/tasks/display_task.o \
./user/tasks/param.o 

C_DEPS += \
./user/tasks/camera_task.d \
./user/tasks/display_task.d \
./user/tasks/param.d 


# Each subdirectory must supply rules for building sources it contributes
user/tasks/%.o: ../user/tasks/%.c
	@echo 'Building file: $<'
